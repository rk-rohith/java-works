...
- [Separate Odd and Even Numbers](https://github.com/rk-rohith/java-works/blob/main/src/java8/SeparateOddEven.java)
- [Remove Duplicate Elements](https://github.com/rk-rohith/java-works/blob/main/src/java8/RemoveDuplicates.java)
- [Find Frequency of Each Character in a String](https://github.com/rk-rohith/java-works/blob/main/src/java8/CharacterFrequency.java)
- [Sort a List of Decimals in Reverse Order](https://github.com/rk-rohith/java-works/blob/main/src/java8/ReverseSortDecimals.java)
- [Join a List of Strings](https://github.com/rk-rohith/java-works/blob/main/src/java8/JoinList.java)
- [Print Multiples of 5 from a List of Integers](https://github.com/rk-rohith/java-works/blob/main/src/java8/MultiplesOf5.java)
- [Find Maximum and Minimum Numbers](https://github.com/rk-rohith/java-works/blob/main/src/java8/MinMaxNumbers.java)
- [Merge Two Arrays and Sort](https://github.com/rk-rohith/java-works/blob/main/src/java8/MergeSortArrays.java)
- [Merge Two Arrays and Remove Duplicates](https://github.com/rk-rohith/java-works/blob/main/src/java8/MergeRemoveDuplicates.java)
- [Get Maximum and Minimum Numbers (Top 3)](https://github.com/rk-rohith/java-works/blob/main/src/java8/MaxMinTop3.java)
- [Sum and Average of Elements in an Integer Array](https://github.com/rk-rohith/java-works/blob/main/src/java8/SumAverage.java)
- [Sort Strings by Length](https://github.com/rk-rohith/java-works/blob/main/src/java8/SortStringsByLength.java)
- [Find Common Elements Between Two Arrays](https://github.com/rk-rohith/java-works/blob/main/src/java8/CommonElements.java)
- [Reverse Words in a String](https://github.com/rk-rohith/java-works/blob/main/src/java8/ReverseWords.java)
- [Sum of First 10 Natural Numbers](https://github.com/rk-rohith/java-works/blob/main/src/java8/SumFirst10Natural.java)
- [Strings Starting with a Number](https://github.com/rk-rohith/java-works/blob/main/src/java8/StringsStartingNumber.java)
- [Sum of square of odd Numbers](https://github.com/rk-rohith/java-works/blob/main/src/java8/oddNumbersSquareSum.java)
- [Employee Stream operation](https://github.com/rk-rohith/java-works/blob/main/src/java8/EmployeeStreamOperations.java)
- [FlatMapExample](https://github.com/rk-rohith/java-works/blob/main/src/java8/FlatMapExample.java)


# Singleton design

- [SingletonExample](https://github.com/rk-rohith/java-works/blob/main/src/singletonClass/Singleton.java)
- [SingletonDoubleChecked](https://github.com/rk-rohith/java-works/blob/main/src/singletonClass/SingletonDoubleChecked.java)
